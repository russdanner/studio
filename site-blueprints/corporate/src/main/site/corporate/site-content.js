...
siteFolder.setPermission("Collaborator", "GROUP_site_" + siteName  + "_SiteContributor");
siteFolder.setPermission("SiteCollaborator", "GROUP_site_" + siteName  + "_SiteContributor");
