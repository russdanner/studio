...
<%
    ...
    //if ("POST".equals(request.getMethod())) {
        ...
        String query = request.getParameter("query"); //queryDocument.getRootElement().getStringValue();
...
<query xmlns:yahoo="http://www.yahooapis.com/v1/base.rng" yahoo:count="10" yahoo:created="2012-07-07T22:54:32Z" yahoo:lang="en-US">
<results>
