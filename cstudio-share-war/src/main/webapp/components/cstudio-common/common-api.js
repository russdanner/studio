	...
	CStudioAuthoring.register({
		...
		OverlayRequiredResources: {
			css: [
				...
				'/themes/cstudioTheme/yui/assets/skin.css',
                '/themes/cstudioTheme/css/contextNav.css',
				'/yui/container/assets/container.css',
				'/jquery/jquery-time/jquery.timeentry.css',
				'/jquery/jquery-ui/themes/smoothness/jquery-ui.css'
			], js: [
				'/yui/connection/connection-min.js',
				'/yui/json/json-min.js',
				'/yui/resize/resize-min.js',
				'/yui/event-delegate/event-delegate-min.js',
				'/yui/container/container_core-min.js',
				...
				'/components/cstudio-contextual-nav/contextual-nav.js',
				'/yui/calendar/calendar-min.js',
                '/components/cstudio-components/loader.js'
            ],
			/**
			...
			*/
			...
			rejectContent: function(site, contentItems) {
				...
				CStudioAuthoring.Module.requireModule("dialog-reject",
						"/components/cstudio-dialogs/reject.js",
						moduleConfig,
						submitDialogCb);
			},
			...
			openUploadDialog: function(site, path, isUploadOverwrite, callback) {
				...
				CStudioAuthoring.Module.requireModule("upload-dialog", "/components/cstudio-dialogs/upload-asset-dialog.js", moduleConfig, openUploadDialogCb);
			},
		    ...
		    openCreateNewFolderDialog: function(site, path, callingWindow, callback) {
				...
				CStudioAuthoring.Module.requireModule("new-folder-name-dialog", "/components/cstudio-dialogs/new-folder-name-dialog.js", moduleConfig, openCreateFolderDialogCb);
			}
		},
		/**
		...
		Service: {
			...
			contextServiceUri: "/service/cstudio/wcm/preview/overlay",
			...
			retrieveContextualNavContent: function(navContext, callback) {
				...
				var serviceUrl = this.contextServiceUri + "/" +  CStudioAuthoringContext.site + "?context=" + navContext;
			...
			reorderServiceCreatePanel: function(panelid, contentTypes, site, control) {
				...
				CStudioAuthoring.Module.requireModule("dialog-nav-order", "/components/cstudio-dialogs/page-nav-order-panel.js", moduleConfig, createDialogOrder);
			},
