 ...
 * @author Russ Danner
 */
public class EndpointPostSubmissionProcessor implements FormSubmissionProcessor {

	private WebScriptEndpoint _webscriptEndpoint;

	private static Log LOGGER = LogFactory.getLog(EndpointPostSubmissionProcessor.class);
	...
	public String processFormSubmission(String formId, InputStream model, String method, String action, Map<String, Object> parameters) {
		...
		return _webscriptEndpoint.post(url, model, parameters).getResponse();
	}
}
