...
(function()
{
   new Alfresco.dashlet.MyCrafterSites("${jsid}").setOptions(
   {
...
<div class="dashlet my-sites">
   ...
   <div class="toolbar flat-button">
      <div class="hidden">
         ...
         <span class="align-left yui-button yui-menu-button" id="${id}-type" style="display:none">
            <span class="first-child">
               <button type="button" tabindex="0">${msg("filter.all")}</button>
            </span>
         </span>
         
         <select id="${id}-type-menu" style="display:none">
