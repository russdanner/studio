...
<div id="${el}-dialog" class="create-site">
   ...
   <div class="bd">
      <form id="${el}-form" method="POST" action="">
         ...
         <div class="yui-gd" style="">
            <div class="yui-u first"><label for="${el}-siteBlueprint">${msg("label.blueprint")}:</label></div>
            <div class="yui-u">
               
               <select id="${el}-siteBlueprint" name="siteBlueprint" tabindex="0">
         ...
         <div class="yui-gd" style="display:none">
            ...
            <div class="yui-u">
               ...
               <select id="${el}-sitePreset" name="sitePreset" tabindex="0">
                  <#list sitePresets as sitePreset>
                     <option value="cstudio-site-dashboard">cstudio-site-dashboard</option>
                  </#list>
               </select>
            </div>
         </div>
