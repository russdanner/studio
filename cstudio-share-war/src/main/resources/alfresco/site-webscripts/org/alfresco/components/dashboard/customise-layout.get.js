...
function main()
{
    ...
    var layouts = {
        ...
        "custom-cstudio-dashboard-1-column" : {
            templateId: "custom-cstudio-dashboard-1-column",
            noOfColumns: 1,
            description: "CStudio WCM Dashboard Layout",
            icon: url.context + "/res/components/dashboard/images/custom-cstudio-dashboard-1-column.png"
        },
