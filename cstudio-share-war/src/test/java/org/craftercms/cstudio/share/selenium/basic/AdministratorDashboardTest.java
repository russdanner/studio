...
public class AdministratorDashboardTest {
  ...
  public void test_on_firefox() {
    test_administrator_dashboard(new FirefoxDriver());
  }
  ...
  private void test_administrator_dashboard(WebDriver driver) {
    // Login
    ...
    // Verify 'Go Live Queue'
    CStudioSeleniumUtil.verify_go_live_queue(driver);

    // Verify 'Approved Scheduled Items'
    CStudioSeleniumUtil.verify_approved_scheduled_items(driver);

    // Verify 'Recently Made Live'
    CStudioSeleniumUtil.verify_recently_made_live(driver);
