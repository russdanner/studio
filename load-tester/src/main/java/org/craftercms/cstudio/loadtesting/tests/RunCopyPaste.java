...
public class RunCopyPaste extends TestingBase {
	
	public void testRunCopyPaste() throws Exception
	{
		Properties props = getProperties();
		String fileName = props.getProperty("runAll.fileName");
		String source = props.getProperty("runCopyPaste.source");
		String destination = TestingConstants.ROOT_PATH + props.getProperty("runCopyPaste.destination");
