...
import org.craftercms.cstudio.loadtesting.actions.GetSiteNav;

public class RunGetSiteNav extends TestCase {

	public void testGetSiteNav() throws Exception
	{
		...
		GetSiteNav getSiteNav = new GetSiteNav(authoringUrl, shareUrl, site, username, ticket);
		getSiteNav.getWidget();
	}
