...
import org.craftercms.cstudio.loadtesting.actions.GetLiveItems;

public class RunGetLiveItems extends TestCase {

	public void testGetLiveItems() throws Exception
	{
		...
		GetLiveItems getLiveItems = new GetLiveItems(authoringUrl, shareUrl, site, username, ticket);
		getLiveItems.getWidget();
	}
