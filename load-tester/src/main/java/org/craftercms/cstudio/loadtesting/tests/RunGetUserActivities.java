...
import org.craftercms.cstudio.loadtesting.actions.GetUserActivities;

public class RunGetUserActivities extends TestCase {
	...
	public void testGetUserActivities() throws Exception
	{
		...
		GetUserActivities getUserActivities = new GetUserActivities(authoringUrl, shareUrl, site, username, ticket);
		getUserActivities.getWidget();
	}
