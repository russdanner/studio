...
import org.craftercms.cstudio.loadtesting.actions.GetGoLiveItems;

public class RunGetGoLiveItems extends TestCase {

	public void testGetGoLiveItems() throws Exception
	{
		...
		GetGoLiveItems getGoLiveItems = new GetGoLiveItems(authoringUrl, shareUrl, site, username, ticket);
		getGoLiveItems.getWidget();
	}
