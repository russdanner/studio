...
import org.craftercms.cstudio.loadtesting.actions.GetScheduledItems;

public class RunGetScheduledItems extends TestCase {

	public void testGetScheduledItems() throws Exception
	{
		...
		GetScheduledItems getScheduledItems = new GetScheduledItems(authoringUrl, shareUrl, site, username, ticket);
		getScheduledItems.getWidget();
	}
