...
public class CStudioPrePublishEventAction extends ActionExecuterAbstractBase {
    
    protected static final Logger logger = LoggerFactory.getLogger(CStudioPrePublishEventAction.class);
    ...
    protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
        _dmWorkflowService.prePublish(actionedUponNodeRef);
    }
