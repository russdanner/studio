...
public class PipelineContentImpl implements PipelineContent {
    ...
    /** Actioned NodeRef **/
    protected NodeRef _actionedNodeRef;
    ...
    public void addProperty(String key, String value) {
        if (_properties == null) {
            _properties = new FastMap<String, String>();
        }
    ...
    @Override
    public NodeRef getActionedNodeRef() {
        return this._actionedNodeRef;  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public void setActionedNodeRef(NodeRef nodeRef) {
        this._actionedNodeRef = nodeRef;
    }
}
