...
public class CStudioActivityServiceImpl extends AbstractRegistrableService implements CStudioActivityService {
	...
	protected CStudioActivityFeedDaoService feedDaoService;
	...
	public void setFeedDaoService(CStudioActivityFeedDaoService feedDaoService) {
    ...
    @Override
    public CStudioActivityFeedDAO getDeletedActivity(String site, String path) {
        try {
            return feedDaoService.getDeletedActivity(site, path);
        } catch (SQLException e) {
            LOGGER.error("Error while getting deleted activity for site: " + site + "; path: " + path, e);
            return null;
        }
    }
}
